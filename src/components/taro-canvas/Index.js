import Taro, { PureComponent, CanvasContext } from "@tarojs/taro";
import { Canvas } from "@tarojs/components";
import { getHeight, downloadImageAndInfo } from "./utils/tool";
import {
  drawImage,
  drawText,
  drawBlock,
...
export default class CanvasDrawer extends PureComponent {
  static defaultProps = {};
  constructor(props) {
    super(props);
    this.state = {
