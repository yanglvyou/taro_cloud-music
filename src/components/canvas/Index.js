...
import base64src from "../base64Src/Index";
import shareImg from "../../assets/images/shareImg.jpg";
...
export default class TestCanvas extends Component {
  ...
  downLoad() {
    ...
    wx.downloadFile({
      url:
        "https://bw-online-img.oss-cn-hangzhou.aliyuncs.com/miniprogram/home/06.png",
  ...
  render() {
    ...
    return (
      <View className="canvas">
        ...
        ></Canvas>
        <AtButton type="primary" circle onClick={this.downLoad.bind(this)}>
          canvas保存图片
        </AtButton>
        {posterImage ? (
          <Image
